...
class ProfileRepositoryImpl implements ProfileRepository {
  ...
  @override
  Future<Either<Failure, UserEntity>> updateProfile(String name, String NIK, DateTime dateOfBirth, String email, String password, String? gender, String? address) async {
    try {
      final userModel = await remoteDataSource.updateProfile(name, NIK, dateOfBirth, email, password, gender, address);
