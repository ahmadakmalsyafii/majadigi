...
class ListLayananPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          sl<ListLayananBloc>()..add(const GetListLayananEvent()),
      child: Scaffold(
        ...
        body: Column(
          children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CustomSearchBar(
                        ...
                        onChanged: (value) {
                          context.read<ListLayananBloc>().add(
                            SearchListLayananEvent(value),
                          );
                        },
                      ),
                    ),
            ...
            Expanded(
              child: BlocBuilder<ListLayananBloc, ListLayananState>(
